...
class ScheduleDataRow extends StatefulWidget {
  ...
  Employee employee;
  Function onrefresh;
  ScheduleDataRow({this.schedule, this.machine, this.employee, this.onrefresh})
      : super();
    ...
    return Padding(
      ...
      child: Material(
        ...
        child: Container(
          ...
          height: 55,
          color: 2 % 2 == 0 ? Colors.white : Colors.grey[50],
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  height: widget.schedule.scheduledStatus.toLowerCase() ==
