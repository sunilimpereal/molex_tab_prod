...
// class PreparationCableDetail extends StatefulWidget {
//   String fgpartNo;
//   String cablePartNo;
//   int? awg;
//   String? color;
...
//   PreparationCableDetail({required this.cablePartNo, required this.fgpartNo,this.color,this.length,this.awg});
//   @override
//   _PreparationCableDetailState createState() => _PreparationCableDetailState();
// }

// class _PreparationCableDetailState extends State<PreparationCableDetail> {
...
//                         Row(
//                           children: [
//                             feild(heading: "Process", value: "${cableTerminalB.processType}", width: 0.05),
//                             feild(
//                                 heading: "Strip Length",
