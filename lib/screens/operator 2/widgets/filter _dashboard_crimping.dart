...
Future<void> showFilterDashBoardCrimping({
  ...
  return showDialog<void>(
    ...
    builder: (BuildContext context) {
      return Center(
          child: DateRangePickerDashCrimping(
        startDate: startDate,
        endDate: endDate,
...
class DateRangePickerDashCrimping extends StatefulWidget {
  DateTime startDate;
  DateTime endDate;
...
class _DateRangePickerDashCrimpingState extends State<DateRangePickerDashCrimping> {
