...
class ProcessPage2 extends StatefulWidget {
  ...
  ProcessPage2(
      {this.schedule, this.machine, this.employee, this.matTrkPostDetail});
  @override
    ...
    return Material(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              width: 1.5, color: color ? Colors.red[500] : Colors.white),
        ),
        child: Row(
          children: [
            Padding(
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                    fontSize: 12, fontFamily: fonts.openSans),
                              ),
                              Text(
